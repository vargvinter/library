...
<div class="form-group">
    ...
    <input class="form-control" id="title" name="title" placeholder="Enter book's title" value="{{ old('title', $book->title) }}">
...
<div class="form-group">
    ...
    <input class="form-control" id="publish_date" name="publish_date" placeholder="Enter book's publish date" value="{{ old('publish_date', $book->publish_date) }}">
